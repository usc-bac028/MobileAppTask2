...
public class ReceptPagerActivity extends AppCompatActivity {

    private static final String EXTRA_RECEIPT_ID =
            "com.bignerdranch.android.receipt.receipt_id";

    private ViewPager mViewPager;
    private List<Receipt> mReceipts;

    public static Intent newIntent(Context packageContext, UUID receiptId) {
        Intent intent = new Intent(packageContext, ReceptPagerActivity.class);
